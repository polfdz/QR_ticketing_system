...
public class SendMail extends AsyncTask<Void,Void,Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        Toast.makeText(context,context.getResources().getString(R.string.correuEnviat),Toast.LENGTH_LONG).show();
    }
    ...
    protected Void doInBackground(Void... params) {
        ...
        props.put("mail.smtp.host", "smtp.dominioabsoluto.net");
        ...
        session = Session.getDefaultInstance(props,
                new javax.mail.Authenticator() {
                    ...
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication(constants.CORREU_USER, constants.CORREU_PASSWORD);
                    }
                });
        ...
        try {
            ...
            mm.setFrom(new InternetAddress(constants.CORREU_USER));
            //Adding receiver
